...
@interface PulseViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@property (weak, nonatomic) IBOutlet NSLayoutConstraint *deleteBtn;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"脉搏：%@",model.attribute1];
    return cell;
}
